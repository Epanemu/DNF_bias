...
def run_experiment(cfg: DictConfig):
    ...
    if cfg.model == "DNF":
        ...
        fams_cfg.model_name = "FcNet4"
        fams_cfg.training_epoch = 50
        fams_cfg.batch_size = 128
        fams_cfg.max_inner = 10
        fams_cfg.max_outer = 5
        fams_cfg.lr_prior = 0.5
        fams_cfg.lr_post = 0.6
        fams_cfg.weight = 0.4
        fams_cfg.divergence_type = "W_Sqr"
        fams_cfg.kappa_prior = 0.01
        fams_cfg.kappa_post = 0.001
        fams_cfg.log_var_init_mean = -0.1
        fams_cfg.log_var_init_var = 0.1
        fams_cfg.eps_std = 0.1
        fams_cfg.n_MC = 5
        fams_cfg.acc_bin = 0.5
        fams_cfg.params = None
        fams_cfg.seed = cfg.seed
        fams_cfg.use_wandb = False
        ...
        fams_model = get_model(fams_cfg).to(device)
        ...
        y_hat_train_prob = fams_inference(fams_model, X_train, fams_cfg)
        y_hat_train = y_hat_train_prob >= 0.5

        raise ValueError("TODO: Check the correctness of FAMS\n")
    else:
